...
public class ItemManagerMenuBar extends MenuBar {
    ...
    public ItemManagerMenuBar(Stage stage) {
        ...
        Dialog<Item> dialog = dialogForItemCreation();
        createItemEventHandler(newItem, dialog);
    ...
    private void createItemEventHandler(MenuItem createItem, Dialog<Item> dialog) {
